...
public static class IconTypesHelper
{
    public static HashSet<int> singleOneLose = new HashSet<int>
    {
        0b0001,
        0b0010,
        0b0100,
    ...
    public static HashSet<int> singleCorner = new HashSet<int>
    {
        0b0011,
        0b0110,
        0b1100,
    ...
    public static HashSet<int> singleFloor = new HashSet<int>
    {
        0b11111111,
        0b01111111,
        0b10111111,
